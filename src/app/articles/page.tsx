    ...
    <main className="flex flex-col items-center justify-between mt-20">
      <Container>
        <div className="flex flex-col items-center justify-center p-6 lg:p-32 text-justify">
          ...
          <div className="lg:flex items-center justify-center mt-10 lg:space-x-6">
            <div className="flex lg:w-1/2 mt-5">
              <p>
            ...
            <div className="flex lg:w-1/2 mt-5">
              <p>
                Life is a journey, and I am encountering new things every
                moment. Recognizing that genuine learning needs to be
                self-dependent, I have created this section on my website to
                record scholarly study notes and insights. This space functions
                as a personal repository for the knowledge and understanding I
                have gained along the way. By sharing my reflections and
                discoveries, I aim to promote deeper engagement with the themes
                I explore and provide resources that contribute to others'
                learning journeys. This approach emphasizes the belief that true
                learning is reinforced by diligent records of self-motivation

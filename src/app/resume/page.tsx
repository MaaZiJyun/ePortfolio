                ...
                <div className="flex w-full">
                  ...
                  <div className="flex lg:flex-1 text-right justify-end">
                    <span>
                      ...
                      and Mobile Application Development, Software Architecture,
                      Electronic commerce
                    </span>
                  </div>
                </div>
              ...
              <div className="py-2">
                ...
                <div className="flex w-full">
                  <p>
                    ...
                    <span>
                      ...
                      This project is a collaboration between the UPM Department
                      of Software Engineering and Columbia Asia Hospital in
                      Malaysia.
                    </span>
                  </p>
                </div>
                <div className="pl-6">
                  ...
                  <div className="flex w-full">
                    ...
                    storage, processing, and user management. Generated
                    databases, URIs, and handled database operations.
                  </div>
                  <div className="flex w-full">
                    • Developed core modules for health data recording,
                    reminders, and personalized suggestions. Created controllers
                    and models using Flutter on the client side.
                  </div>
                  <div className="flex w-full">
              ...
              <div className="py-2">
                ...
                <div className="flex w-full">
                  <span>
                    ...
                    assisted in decorating and setting up the event environment.
                  </span>
                </div>
              </div>
              <div className="py-2">

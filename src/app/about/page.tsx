        ...
        <div className="flex flex-col w-full px-6 lg:px-12">
          ...
          <div className="pt-10">
            <p>
              ...
              passion for music and writing. I am fluent in English and native
              in Chinese. I graduated from UPM with a Bachelor&apos;s degree in
              Software Engineering and am currently pursuing a Master&apos;s
              degree at PolyU.
            </p>
            <div className="mt-2">
              <p>
                My email is{" "}
                <span className="underline">domukino@gmail.com</span>, and feel
            ...
            <div className="py-2">
              ...
              <div className="flex w-full">
                <p>
                  ...
                  <span>
                    ...
                    women, thereby improving their health during pregnancy. This
                    project is a collaboration between the UPM Department of
                    Software Engineering and Columbia Asia Hospital in Malaysia.
                  </span>
                </p>
              </div>
              <div className="pl-6">
              ...
              <div className="pl-6">
                ...
                <div className="flex w-full">
                  ...
                  components for real-time monitoring and control of the smart
                  cradle system.
                </div>
                <div className="flex w-full">
          ...
          <div className="pt-10">
            ...
            <div className="py-2">
              ...
              <div className="flex w-full">
                <p>
                  ...
                  <span>
                    ...
                    offers secure, and flexible loan solutions for individuals
              ...
              <div className="pl-6">
                ...
                <div className="flex w-full">
                  • Met specific requirements and design criteria provided by
                  EOS System Sdn. Bhd.
                </div>
                <div className="flex w-full">
          ...
          <div className="pt-10">
            ...
            <div className="py-2">
              ...
              <div className="flex w-full">
                <span>
                  • Helped manage items, guided students in route, and assisted
                  in decorating and setting up the event environment.
                </span>
              </div>
            </div>
            <div className="py-2">
              ...
              <div className="flex w-full">
                <span>
                  ...
                  &quot;International Learning Online Sharing Experiences&quot;
                  at Minggu Perkasa Putra (MPP).
                </span>
              </div>
            </div>
            <div className="py-2">
